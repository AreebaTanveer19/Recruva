   ...
   <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300 px-4 sm:px-6 lg:px-8">
    ...
    <div className="relative mx-auto w-full max-w-4xl">
      <div className="grid items-stretch gap-8 lg:grid-cols-2">
        ...
        {/* LEFT SIDE – Branding */}
        <div className="hidden lg:flex relative min-h-[520px] flex-col justify-center gap-6 overflow-hidden rounded-[32px] p-12 text-white shadow-2xl bg-gradient-to-b from-black to-gray-800">
          ...
          <div className="relative z-10 flex flex-col gap-4 text-center lg:text-left">
            ...
            <p className="text-sm sm:text-base text-gray-300 max-w-sm mx-auto lg:mx-0">
              ...
              Manage confidently — log in with trust.
            </p>
          </div>
        </div>

        {/* RIGHT SIDE – Login Form */}
        <div className="relative min-h-[520px] lg:min-h-[560px] rounded-[32px] border border-gray-700 bg-gray-950 p-6 sm:p-10 shadow-xl flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 rounded-2xl bg-gray-800 py-3 font-semibold text-white shadow-lg hover:bg-gray-700 disabled:opacity-60 disabled:cursor-not-allowed"
            >
