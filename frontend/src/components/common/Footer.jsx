  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { label: 'Careers', href: '/candidate/auth' },
      ],
    },
    {
      title: 'Legal',
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed">
              AI-powered recruitment platform that helps companies find and hire
            ...
            <div key={section.title}>
              ...
              <ul className="space-y-2">
                {section.links.map((link) => {
                  // Use Link for internal routes, <a> for anchors and external links
                  const isInternalRoute = link.href.startsWith('/');
                  const isAnchor = link.href.startsWith('/#');

                  if (isInternalRoute && !isAnchor) {
                    return (
                      <li key={link.label}>
                        <Link
                          to={link.href}
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            © {currentYear} Recruva. All rights reserved.
          </p>
